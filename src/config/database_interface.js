...
export async function addNewItem(
  ...
  await updateDocumentById("items", docRef.id, { id: docRef.id });
 ...
 * @param recordMap
 */
export async function addNewImportRecord(
  recordID,
  recordUserID,
  recordDate,
  recordMap
...
export async function addNewExportRecord(
  exportUserID,
  exportDropAreaID,
  exportDate,
  itemToAmountMap
